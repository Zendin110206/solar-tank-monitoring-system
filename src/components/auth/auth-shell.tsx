  ...
  return (
    <div className="relative mt-8 flex min-h-0 flex-1 items-center justify-center">
      <div className="login-visual-float relative w-full max-w-[34rem]">
        ...
        <div className="relative overflow-hidden rounded-xl border border-white/15 bg-white p-5 text-zinc-950 shadow-2xl shadow-blue-950/35 sm:p-6">
        ...
        <div className="absolute -bottom-4 -left-6 hidden w-40 rotate-[-4deg] rounded-lg border border-white/20 bg-white p-4 shadow-xl shadow-blue-950/30 sm:block">
        ...
        <div className="absolute -right-5 -top-7 hidden w-44 rotate-3 rounded-lg border border-white/20 bg-[#ffdf42] p-4 text-zinc-950 shadow-xl shadow-blue-950/30 sm:block">
...
export default function AuthShell({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-zinc-100 px-4 py-5 text-zinc-950 sm:px-6">
      ...
      <div
        aria-hidden="true"
        className="absolute -left-24 top-12 size-72 rounded-full bg-cyan-300/25 blur-3xl"
      />
      <div
        aria-hidden="true"
        className="absolute -right-24 bottom-0 size-80 rounded-full bg-red-300/20 blur-3xl"
      />

      <section className="login-shell-enter relative mx-auto grid min-h-[calc(100vh-2.5rem)] w-full max-w-[1320px] overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-[0_28px_90px_rgba(24,24,27,0.14)] lg:min-h-[760px] lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="flex min-w-0 flex-col px-5 py-6 sm:px-10 sm:py-8 lg:px-14 xl:px-20">
          ...
          >
            <h1 className="text-[clamp(2rem,3vw,2.5rem)] font-medium leading-tight tracking-[-0.025em] text-zinc-950">
              {heading}
            </h1>
        ...
        <aside className="relative m-2 hidden min-w-0 overflow-hidden rounded-xl bg-[#0d2d6e] p-10 text-white lg:flex lg:flex-col xl:p-12">
          <div
            aria-hidden="true"
          ...
          <div
            aria-hidden="true"
            className="absolute -right-24 -top-24 size-80 rounded-full bg-blue-500/50 blur-2xl"
          />
          <div
            aria-hidden="true"
            className="absolute -bottom-20 -left-24 size-72 rounded-full bg-cyan-400/25 blur-3xl"
          />
          <div
            aria-hidden="true"
          ...
          <div className="relative z-10 max-w-xl">
            <h2 className="text-[clamp(2rem,3vw,3rem)] font-medium leading-[1.08] tracking-[-0.03em]">
              Monitoring tangki,
              <span className="block text-cyan-300">
                lebih jelas dalam satu layar.
              </span>
            </h2>
            <p className="mt-5 max-w-lg text-sm leading-7 text-blue-100/85 sm:text-base">
          ...
          <div className="relative z-10 mt-8 flex items-center justify-between gap-5 border-t border-white/15 pt-5 text-xs text-blue-100/75">
