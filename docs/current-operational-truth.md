...
FTM adalah **pilot operasional internal yang aktif**, bukan lagi dashboard dummy
atau konsep portfolio. Sistem telah menerima telemetry perangkat fisik melalui
deployment Vercel, menyimpannya di Aiven MySQL, dan menampilkannya kepada akun
pengguna nyata. Konteks penerapannya berada di lingkungan Telkom
...
| Storage development terotorisasi | MySQL aktif |
| Registry MySQL | 3 site, 3 tangki, 3 device |
| Reading pada audit 13 Juli | 9.272 |
| Kesegaran saat audit | 2 device fresh, 1 device stale |
